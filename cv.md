	...
	<div class = "cv_item">
		...
		<div class = "cv_item_content">
			...
			<div class = "cv_item">
				...
				<div class ="cv_item_content">
					CMMI (capability Maturity Model Integration), test unitaires de régression, d’intégration, qualité : Sonar, Jdepend, sécurité.
				</div>
			</div>
		</div>
	</div>
